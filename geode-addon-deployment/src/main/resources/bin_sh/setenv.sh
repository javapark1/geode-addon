...
# to set in this file to drive geode-addon.
#
# Required:
# ---------
# GEODE_HOME         Geode IMDG root directory path
#
# Optional:
# ---------
...
#
#JAVA_OPTS="-Dgeode.query.predicate.parallel.evaluation=true"
...
# 
# Enter your Geode home directory.
#
#GEODE_HOME=
